...
class Google::Protobuf::FileDescriptorProto < Google::Protobuf::AbstractMessage
  sig do
    params(
      dependency: T.nilable(T::Array[String]),
      edition: T.nilable(T.any(Symbol, Integer)),
      enum_type: T.nilable(T::Array[Google::Protobuf::EnumDescriptorProto]),
      extension: T.nilable(T::Array[Google::Protobuf::FieldDescriptorProto]),
      message_type: T.nilable(T::Array[Google::Protobuf::DescriptorProto]),
      name: T.nilable(String),
      option_dependency: T.nilable(T::Array[String]),
      options: T.nilable(Google::Protobuf::FileOptions),
      package: T.nilable(String),
      public_dependency: T.nilable(T::Array[Integer]),
      service: T.nilable(T::Array[Google::Protobuf::ServiceDescriptorProto]),
      source_code_info: T.nilable(Google::Protobuf::SourceCodeInfo),
      syntax: T.nilable(String),
      weak_dependency: T.nilable(T::Array[Integer])
    ).void
  end
  def initialize(dependency: T.unsafe(nil), edition: nil, enum_type: T.unsafe(nil), extension: T.unsafe(nil), message_type: T.unsafe(nil), name: nil, option_dependency: T.unsafe(nil), options: nil, package: nil, public_dependency: T.unsafe(nil), service: T.unsafe(nil), source_code_info: nil, syntax: nil, weak_dependency: T.unsafe(nil)); end
  ...
  sig { void }
  def clear_option_dependency; end
  ...
  sig { returns(Google::Protobuf::RepeatedField[String]) }
  def option_dependency; end

  sig { params(value: Google::Protobuf::RepeatedField[String]).void }
  def option_dependency=(value); end
