...
class Google::Protobuf::DescriptorProto < Google::Protobuf::AbstractMessage
  sig do
    params(
      ...
      extension_range: T.nilable(T::Array[Google::Protobuf::DescriptorProto::ExtensionRange]),
      field: T.nilable(T::Array[Google::Protobuf::FieldDescriptorProto]),
      name: T.nilable(String),
      nested_type: T.nilable(T::Array[Google::Protobuf::DescriptorProto]),
      oneof_decl: T.nilable(T::Array[Google::Protobuf::OneofDescriptorProto]),
      options: T.nilable(Google::Protobuf::MessageOptions),
      reserved_name: T.nilable(T::Array[String]),
      reserved_range: T.nilable(T::Array[Google::Protobuf::DescriptorProto::ReservedRange]),
      visibility: T.nilable(T.any(Symbol, Integer))
    ).void
  end
  def initialize(enum_type: T.unsafe(nil), extension: T.unsafe(nil), extension_range: T.unsafe(nil), field: T.unsafe(nil), name: nil, nested_type: T.unsafe(nil), oneof_decl: T.unsafe(nil), options: nil, reserved_name: T.unsafe(nil), reserved_range: T.unsafe(nil), visibility: nil); end
